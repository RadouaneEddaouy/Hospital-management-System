                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
							<span class="dash-widget-bg1"><i class="fa-solid fa-user-nurse" aria-hidden="true"></i></span>
							<?php
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg2"><i class="fa-brands fa-accessible-icon"></i></span>
                            <?php
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <?php
							$fetch_query = mysqli_query($connection, "select count(*) as total from tbl_schedule"); 
							$attend = mysqli_fetch_row($fetch_query);
							?>
                            <div class="dash-widget-info text-right">
                                <h3><?php echo $attend[0]; ?></h3>
                                <span class="widget-title3">Programmes <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg4"><i class="fa-solid fa-heart"></i></span>
                            <?php
                            ...
                            <div class="dash-widget-info text-right">
                                ...
                                <span class="widget-title4"> Patients Sortis <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg4"><i class="fa-solid fa-bed-pulse" aria-hidden="true"></i></span>
                            <?php
                            ...
                            <div class="dash-widget-info text-right">
                                ...
                                <span class="widget-title4">Patients Hospitalisé<i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg3"><i class="fa-regular fa-calendar-check" aria-hidden="true"></i></span>
                            <?php
							$fetch_query = mysqli_query($connection, "select (count(*)-1) as total from tbl_appointment"); 
							$inpatient = mysqli_fetch_row($fetch_query);
							?>
                            <div class="dash-widget-info text-right">
                                <h3><?php echo $inpatient[0]; ?></h3>
                                <span class="widget-title3">Rendez Vous<i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
                       ...
                       <div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Nouveaux Patients</h4> <a href="patients.php" class="btn btn-primary float-right">Voir tout</a>
							</div>
					  ...
					  <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="doctors.php" class="text-muted">Voir tous les médecins</a>
                            </div>
                        </div>
                    </div>
				</div>
