...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../redopng.png">
				...
				<div class="account-box">
                    <form method="post" class="form-signin">
						<div class="account-logo">
                            <a href="index-2.html"><img src="../logoo.png" ></a>
                        </div>
                        ...
                        <div class="form-group text-center">
                            <button type="submit" name="login" class="btn btn-primary account-btn mt-4">Login</button>
                        </div>
