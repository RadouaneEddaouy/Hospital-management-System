...
if(isset($_REQUEST['save-schedule']))
{
      ...
      if($update_query>0)
      {
          $msg = "Planing mis à jour avec succès";
          $fetch_query = mysqli_query($connection, "select * from tbl_schedule where id='$id'");
          $row = mysqli_fetch_array($fetch_query);   
      }
      else
                    ...
                    <div class="col-lg-8 offset-lg-2">
                         <form method="post">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" multiple name="days[]" required>
                                            <option value=""  disabled >sélectionner des jours</option>
                                            <?php
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="save-schedule">sauvegarder</button>
                            </div>
                        </form>
                    </div>
                </div>
