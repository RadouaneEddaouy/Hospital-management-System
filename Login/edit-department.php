...
?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 ">
                        <h4 class="page-title">Modifier le département</h4>
                    </div>
                    <div class="col-sm-8  text-right m-b-20">
                        <a href="departments.php" class="btn btn-primary btn-rounded float-right">Précédent</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <label class="display-block">Statut de département </label>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="save-department">sauvegarder</button>
                            </div>
                        </form>
