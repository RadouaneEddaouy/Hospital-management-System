...
if(isset($_REQUEST['save-appointment']))
{
      ...
      if($update_query>0)
      {
          $msg = "Rendez-vous mis à jour avec succès. ";
          $fetch_query = mysqli_query($connection, "select * from tbl_appointment where id='$id'");
          $row = mysqli_fetch_array($fetch_query);   
...
?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 ">
                        <h4 class="page-title">Modifier le rendez-vous</h4>
                    </div>
                    <div class="col-sm-8  text-right m-b-20">
                        <a href="appointments.php" class="btn btn-primary btn-rounded float-right">Précédent</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post" >
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>ID de rendez-vous  <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="appointment_id" required value="<?php  echo $row['appointment_id'];  ?>"> 
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="display-block">Statut du Rendez-Vous</label>
                            ...
                            <div class="m-t-20 text-center">
                                <button name="save-appointment" class="btn btn-primary submit-btn">Sauvegarder</button>
                            </div>
                        </form>
                    </div>
                </div>
