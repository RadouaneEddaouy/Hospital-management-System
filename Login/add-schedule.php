...
?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 ">
                        <h4 class="page-title">Ajouter une Planification</h4>
                         
                    </div>
                    <div class="col-sm-8  text-right m-b-20">
                        <a href="schedule.php" class="btn btn-primary btn-rounded float-right">Précédent</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" multiple name="days[]" required>
                                            <option value="">Sélectionnez Des jours</option>
                                            <option>Lundi</option>
                                            <option>Mardi</option>
                            ...
                            <div class="form-group">
                                <label class="display-block">Statut de la Planification</label>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="add-schedule">Créer un Programme</button>
                            </div>
                        </form>
                    </div>
                </div>
